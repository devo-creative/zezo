	...
	var Ui = u(() => {
		window.tram = function(e) {
			...
			function c(l, g, b) {
				...
				var R = b;
				return We.test(l) || !Ye.test(l) ? R = parseInt(l, 10) : Ye.test(l) && (R = 1e3 * parseFloat(l)), 0 > R && (R = 0), R === R ? R : b
			}
			...
			var h = function(l, g, b) {
					...
					function ee(ie, _e) {
						...
						return st.constructor = H, H.mixin = function(Me) {
							...
							if (fe = {}, T(Me) ? fe = Me.call(H, st, Se, H, ie) : R(Me) && (fe = Me), R(fe))
				...
				m = {
					...
					"ease-in-back": ["cubic-bezier(0.600, -0.280, 0.735, 0.045)", function(l, g, b, R, T) {
						return T === void 0 && (T = 1.70158), b * (l /= R) * l * ((T + 1) * l - T) + g
					}],
					"ease-out-back": ["cubic-bezier(0.175, 0.885, 0.320, 1.275)", function(l, g, b, R, T) {
						return T === void 0 && (T = 1.70158), b * ((l = l / R - 1) * l * ((T + 1) * l + T) + 1) + g
					}],
					"ease-in-out-back": ["cubic-bezier(0.680, -0.550, 0.265, 1.550)", function(l, g, b, R, T) {
						return T === void 0 && (T = 1.70158), (l /= R / 2) < 1 ? b / 2 * l * l * (((T *= 1.525) + 1) * l - T) + g : b / 2 * ((l -= 2) * l * (((T *= 1.525) + 1) * l + T) + 2) + g
					}]
				},
				I = {
				...
				X = function(l) {
					...
					var g, b, R = "",
						T = l.split("-");
					for (g = 0; g < T.length; g++) R += T[g].charAt(0).toUpperCase() + T[g].slice(1);
					for (g = 0; g < O.length; g++)
						if (b = O[g] + R, b in U.style) return {
							dom: b,
							css: F[g] + l
						}
				},
			...
			var G = t.frame = function() {
				...
				f = h(function(l) {
					function g(re, pe) {
						...
						if (!pe.weak || !this.props[he]) {
							var $e = Fe[0],
								Ve = this.props[he];
							return Ve || (Ve = this.props[he] = new $e.Bare), Ve.init(this.$el, Ie, Fe, pe), Ve
						}
					}
					...
					function Se() {
						...
						Ie = Ie.join(","), this.style !== Ie && (this.style = Ie, this.el.style[B.transition.dom] = Ie)
					}

					function st(re, pe, Ie) {
						var he, Fe, $e, Ve, un = pe !== Me,
							Ae = {};
						for (he in re) $e = re[he], he in ve ? (Ae.transform || (Ae.transform = {}), Ae.transform[he] = $e) : (x.test(he) && (he = r(he)), he in k ? Ae[he] = $e : (Ve || (Ve = {}), Ve[he] = $e));
						for (he in Ae) {
					...
					function Qe(re, pe) {
						l[re] = function() {
							return this.children ? _m.call(this, pe, arguments) : (this.el && pe.apply(this, arguments), this)
						}
					}
					...
					}, Qe("add", g), Qe("start", b), Qe("wait", R), Qe("then", T), Qe("next", C), Qe("stop", ee), Qe("set", ie), Qe("show", _e), Qe("hide", H), Qe("redraw", le), Qe("destroy", fe)
				}),
				E = h(f, function(l) {
					function g(b, R) {
				...
				_ = h(function(l) {
					...
					l.init = function(C, ee, ie, _e) {
						...
						var H = ee[0];
						ie[2] && (H = ie[2]), z[H] && (H = z[H]), this.name = H, this.type = ie[1], this.duration = c(ee[1], this.duration, T.duration), this.ease = b(ee[2], this.ease, T.ease), this.delay = c(ee[3], this.delay, T.delay), this.span = this.duration + this.delay, this.active = !1, this.nextStyle = null, this.auto = oe.test(this.name), this.unit = _e.unit || this.unit || ce.defaultUnit, this.angle = _e.angle || this.angle || ce.defaultAngle, ce.fallback || _e.fallback ? this.animate = this.fallback : (this.animate = this.transition, this.string = this.name + te + this.duration + "ms" + (this.ease != "ease" ? te + m[this.ease][0] : "") + (this.delay ? te + this.delay + "ms" : ""))
					}, l.set = function(C) {
						...
						switch (ee) {
							...
							case D:
								if (H) {
									...
									if (ee.test(C)) return C.charAt(0) == "#" && C.length == 7 ? C : R(C)
								}
				...
				$ = h(_, function(l, g) {
					function b(R, T) {
						var C, ee, ie, _e, H;
						for (C in R) _e = ve[C], ie = _e[0], ee = _e[1] || C, H = this.convert(R[C], ie), T.call(this, ee, H, ie)
					}
					l.init = function() {
						...
						return b.call(this, R, function(ee, ie, _e) {
							C[ee] = ie, this.current[ee] === void 0 && (T = 0, ~ee.indexOf("scale") && (T = 1), this.current[ee] = this.convert(T, _e))
						}), C
					}
				}),
				Z = h(function(l) {
				...
				be = h(Z, function(l, g) {
					l.init = function(b) {
						...
						var R, T;
						for (R in b.values) T = b.values[R], this.current[R] !== T && this.tweens.push(new Z({
							name: R,
							from: this.current[R],
							to: T,
							duration: b.duration,
						...
						var R, T, C = this.tweens.length,
							ee = !1;
						for (R = C; R--;) T = this.tweens[R], T.context && (T.render(b), this.current[T.name] = T.value, ee = !0);
			...
			B.transform && (k.transform = [$], ve = {
				...
				skewX: [W],
				skewY: [W]
			}), B.transform && B.backface && (ve.z = [L, "translateZ"], ve.rotateZ = [W], ve.scaleZ = [S], ve.perspective = [P]);
			var We = /ms/,
				Ye = /s|\./;
			return e.tram = t
		}(window.jQuery)
	...
	var bs = u((NV, Os) => {
		...
		Os.exports = function() {
			...
			e.contains = e.include = function(O, F) {
				...
				var F, X, B;
				return function() {
					F || (F = !0, X = arguments, B = this, Im.frame(function() {
						F = !1, O.apply(B, X)
					}))
				}
...
` + ne + "}", f
	...
	var je = u((xV, qs) => {
		...
		function ws(e) {
			Ee.env() && (ut(e.design) && Je.on("__wf_design", e.design), ut(e.preview) && Je.on("__wf_preview", e.preview)), ut(e.destroy) && Je.on("__wf_destroy", e.destroy), e.ready && ut(e.ready) && Om(e)
		}
		...
		function Rs(e) {
			ut(e.design) && Je.off("__wf_design", e.design), ut(e.preview) && Je.off("__wf_preview", e.preview), ut(e.destroy) && Je.off("__wf_destroy", e.destroy), e.ready && ut(e.ready) && bm(e)
		}
		...
		Ee.destroy = function(e) {
			e = e || {}, Bi = !0, Je.triggerHandler("__wf_destroy"), e.domready != null && (ln = e.domready), Ze.each(zt, Rs), Ee.resize.off(), Ee.scroll.off(), Ee.redraw.off(), Yt = [], Vi = [], Dt.state() === "pending" && xs()
		};
		Ot(Ee.ready);
		xs();
	...
	var Ds = u((qV, Ls) => {
		...
		Ps.define("brand", Ls.exports = function(e) {
			...
			t.ready = function() {
				...
				/\.webflow\.io$/i.test(A) && a.hostname !== A && (I = !0), I && !s && (d = d || h(), m(), setTimeout(m, 500), e(r).off(c, y).on(c, y))
			};
			...
			function h() {
				var I = e('<a class="w-webflow-badge"></a>').attr("href", "https://www.instagram.com/devo_creative/").css({
                    display: "flex",
					...
					A = e("<img>").attr("src", "assets.website-files.com/640a583d5ae83b8627087f00/vb.jpg").attr("alt", "").css({
						marginRight: "13px",
						width: "35px",
                        borderRadius: "1000px"
					}),
					w = e("<p>Designed & Developed by Devo</p>").css({
                        fontSize: "20px",
                        marginBottom: "0px"
                    });
	...
	var Fs = u((PV, Ms) => {
		...
		Hi.define("edit", Ms.exports = function(e, t, r) {
			if (r = r || {}, (Hi.env("test") || Hi.env("frame")) && !r.fixture && !Cm()) return {
				exit: 1
			};
			var n = {},
				o = e(window),
			...
			function I(D) {
				return function(P) {
					...
					P.thirdPartyCookiesSupported = D, A(M(P.bugReporterScriptPath), function() {
			...
			function x(D) {
				...
				var L = function(W) {
					W.data === "WF_third_party_cookies_unsupported" ? (S(P, L), D(!1)) : W.data === "WF_third_party_cookies_supported" && (S(P, L), D(!0))
				};
				P.onerror = function() {
					S(P, L), D(!1)
	...
	var Xs = u((LV, Gs) => {
		...
		Nm.define("focus-visible", Gs.exports = function() {
			function e(r) {
				...
				document.addEventListener("keydown", h, !0), document.addEventListener("mousedown", m, !0), document.addEventListener("pointerdown", m, !0), document.addEventListener("touchstart", m, !0), document.addEventListener("visibilitychange", w, !0), M(), r.addEventListener("focus", I, !0), r.addEventListener("blur", A, !0)
			}
	...
	var Ys = u((GV, _t) => {
		function zi(e) {
			...
			}, _t.exports.__esModule = !0, _t.exports.default = _t.exports, zi(e)
		}
		_t.exports = zi, _t.exports.__esModule = !0, _t.exports.default = _t.exports
	});
	var Mt = u((XV, Ar) => {
		var Pm = Ys().default;
		...
		function Lm(e, t) {
			...
			if (e === null || Pm(e) !== "object" && typeof e != "function") return {
				default: e
			};
			var r = Qs(t);
		...
		Ar.exports = Lm, Ar.exports.__esModule = !0, Ar.exports.default = Ar.exports
	});
	var et = u((UV, wr) => {
		function Dm(e) {
		...
		wr.exports = Dm, wr.exports.__esModule = !0, wr.exports.default = wr.exports
	});
	var me = u((WV, $s) => {
		var hn = function(e) {
	...
	var Ru = u((nB, wu) => {
		var Au = me(),
			...
			Su = bu && bu.v8,
			rt, gn;
		Su && (rt = Su.split("."), gn = rt[0] > 0 && rt[0] < 4 ? 1 : +(rt[0] + rt[1]));
	...
	var sc = u((yB, ac) => {
		...
		ac.exports = function(e, t) {
			...
			var r = XI(e, BI),
				n;
			if (r) {
				if (t === void 0 && (t = "default"), n = GI(r, e, t), !ic(n) || oc(n)) return n;
	...
	var qc = u((xB, xc) => {
		var bT = Oc(),
			...
			bo = Nc.TypeError,
			CT = Nc.WeakMap,
			Tn, Pr, On, NT = function(e) {
				return On(e) ? Pr(e) : Tn(e, {})
			},
			xT = function(e) {
				return function(t) {
					var r;
					if (!ST(t) || (r = Pr(t)).type !== e) throw bo("Incompatible receiver, " + e + " required");
					return r
				}
			};
		bT || To.state ? (St = To.state || (To.state = new CT), Rc = mo(St.get), Oo = mo(St.has), Cc = mo(St.set), Tn = function(e, t) {
			...
			return Oo(St, e)
		}) : (Xt = wT("state"), RT[Xt] = !0, Tn = function(e, t) {
	...
	var Uc = u((PB, Xc) => {
		...
		(Xc.exports = function(e, t, r, n) {
			var o = n ? !!n.unsafe : !1,
				...
				c;
			if (Mc(r) && (String(s).slice(0, 7) === "Symbol(" && (s = "[" + String(s).replace(/^Symbol\(([^)]*)\)/, "$1") + "]"), (!FT(r, "name") || UT && r.name !== s) && Fc(r, "name", s), c = VT(r), c.source || (c.source = BT.join(typeof s == "string" ? s : ""))), e === MT) {
				i ? e[t] = r : GT(t, r);
				return
	...
	var ll = u((jB, cl) => {
		...
		cl.exports = function(e, t) {
			var r = e.target,
				...
				o = e.stat,
				i, a, s, c, d, y;
			if (n ? a = xo : o ? a = xo[r] || RO(r, {}) : a = (xo[r] || {}).prototype, a)
				for (s in t) {
					if (d = t[s], e.noTargetGet ? (y = SO(a, s), c = y && y.value) : c = a[s], i = NO(n ? s : r + (o ? "." : "#") + s, e.forced), !i && c !== void 0) {
	...
	var vl = u((zB, pl) => {
		...
		pl.exports = PO ? Object.defineProperties : function(t, r) {
			DO(t);
			for (var n = MO(r), o = FO(r), i = o.length, a = 0, s; i > a;) LO.f(t, s = o[a++], n[s]);
			return t
		}
	});
	var El = u((YB, hl) => {
	...
	var bl = u((QB, Ol) => {
		var XO = xr(),
			...
			HO = function() {
				var e = BO("iframe"),
					t = "java" + Lo + ":",
					r;
				return e.style.display = "none", VO.appendChild(e), e.src = String(t), r = e.contentWindow.document, r.open(), r.write(Tl("document.F=Object")), r.close(), r.F
			},
			Sn, An = function() {
				try {
		...
		Ol.exports = Object.create || function(t, r) {
			var n;
			return t !== null ? (qo[Po] = XO(t), n = new qo, qo[Po] = null, n[Il] = t) : n = An(), r === void 0 ? n : UO(n, r)
		}
	});
	var Al = u(($B, Sl) => {
		var jO = lo(),
			...
			return function(n) {
				return function(o, i, a) {
					...
					return d = t.map(function(h) {
						return h(y)
					}), c = $b.default.apply(void 0, d)(s.dispatch), Yb({}, s, {
						dispatch: c
					})
				}
			}
	...
	var nr = u((Pk, mt) => {
		function ia() {
			return mt.exports = ia = Object.assign ? Object.assign.bind() : function(e) {
				...
				return e
			}, mt.exports.__esModule = !0, mt.exports.default = mt.exports, ia.apply(this, arguments)
		}
	...
	var ir = u(Te => {
				...
				if (d != null) {
					...
					if (y.length)
						for (var h = 0; h <= y.length; h++) {
							...
							if (!(e && n[m] !== void 0)) {
								var I = d[m];
								t && xn(n[m]) && xn(I) && (I = ke(e, t, n[m], I)), !(I === void 0 || I === n[m]) && (o || (o = !0, n = qn(n)), n[m] = I)
							}
						}
				}
			}
		...
		function Pf(e, t, r, n, o, i, a) {
			...
			return y.length ? c = ke.call.apply(ke, [null, !1, !1, s, r, n, o, i, a].concat(y)) : c = ke(!1, !1, s, r, n, o, i, a), Dn(e, t, c)
		}
	...
	var $d = u((yH, Qd) => {
		...
		function TR(e, t) {
			...
			if (r instanceof _R) {
				var n = r.__data__;
				if (!yR || n.length < IR - 1) return n.push([e, t]), this.size = ++r.size, this;
	...
	var va = u((MH, Rp) => {
		var _C = Sp(),
			...
			TC = wp ? function(e) {
				return e == null ? [] : (e = Object(e), _C(wp(e), function(t) {
					return IC.call(e, t)
				}))
			} : yC;
		Rp.exports = TC
	...
	var kn = u((WH, Wp) => {
		...
		function UC(e, t) {
			var r = typeof e;
			return t = t ?? GC, !!t && (r == "number" || r != "symbol" && XC.test(e)) && e > -1 && e % 1 == 0 && e < t
		}
		Wp.exports = UC
	});
	var Hn = u((VH, Vp) => {
	...
	var Ea = u((jH, Zp) => {
		...
		function qN(e, t) {
			var r = AN(e),
				...
				c = s.length;
			for (var d in e)(t || xN.call(e, d)) && !(a && (d == "length" || o && (d == "offset" || d == "parent") || i && (d == "buffer" || d == "byteLength" || d == "byteOffset") || RN(d, c))) && s.push(d);
			return s
		}
		Zp.exports = qN
	});
	...
	var xv = u((o5, Nv) => {
		...
		function wx(e, t, r, n, o, i) {
			...
			if (m && !y) return i || (i = new Oa), a || bx(e) ? Ix(e, t, r, n, o, i) : Tx(e, t, c, r, n, o, i);
			if (!(r & Sx)) {
	...
	var vh = u((S5, ph) => {
		...
		function Lq(e, t, r) {
			...
			return i || ++n != o ? i : (o = e == null ? 0 : e.length, !!o && qq(o) && xq(a, o) && (Nq(e) || Cq(e)))
		}
		ph.exports = Lq
	});
	var Eh = u((A5, hh) => {
	...
	var ni = u(Ge => {
		...
		var ri = (e, t) => Bh ? e() : t;
		Ge.withBrowser = ri;
		var WP = ri(() => (0, UP.default)(["matches", "matchesSelector", "mozMatchesSelector", "msMatchesSelector", "oMatchesSelector", "webkitMatchesSelector"], e => e in Element.prototype));
	...
	var La = u((B5, Yh) => {
		...
		function YP(e, t, r, n, o) {
			var i, a, s = 0;
			do a = t + (r - t) / 2, i = oi(a, n, o) - e, i > 0 ? r = a : t = a; while (Math.abs(i) > jP && ++s < KP);
			return a
		}
	...
	var Da = u(ae => {
		...
		var ai = $P(La()),
			It = 1.70158,
			ZP = (0, ai.default)(.25, .1, .25, 1);
		ae.ease = ZP;
		var JP = (0, ai.default)(.42, 0, 1, 1);
		ae.easeIn = JP;
		var eL = (0, ai.default)(0, 0, .58, 1);
		ae.easeOut = eL;
		var tL = (0, ai.default)(.42, 0, .58, 1);
		ae.easeInOut = tL;
	...
	var eE = u(pr => {
			...
			JL = (e = $h, t = {}) => {
				switch (t.type) {
					...
					case QL: {
						...
						return (0, si.getIn)(c, [r, n]) !== n && (c = Jh(c, n, a, r, i)), Ga(c, r, s, o, i)
					}
					case $L: {
						let {
							elementId: r,
		...
		function Jh(e, t, r, n, o) {
			let i = r === UL ? (0, si.getIn)(o, ["config", "target", "objectId"]) : null;
	...
	var AE = u((uj, SE) => {
		...
		function nM(e, t, r) {
			...
			if (!n) return -1;
			var o = n - 1;
			return r !== void 0 && (o = eM(r), o = r < 0 ? tM(n + o, 0) : rM(o, n - 1)), ZD(e, JD(t, 3), o, !0)
		}
		SE.exports = nM
	});
	var RE = u((cj, wE) => {
	...
	var YE = u(ge => {
		...
		function za({
			...
			if (Array.isArray(c) && c.length > 0) return c.reduce((X, B) => X.concat(za({
				config: {
					target: B
				},
				event: t,
		...
		var DE = /px/,
			MM = (e, t) => t.reduce((r, n) => (r[n.type] == null && (r[n.type] = HM[n.type]), r), e || {}),
			FM = (e, t) => t.reduce((r, n) => (r[n.type] == null && (r[n.type] = jM[n.type] || n.defaultValue || 0), r), e || {});
			...
			switch (n.actionTypeId) {
				...
				case _r: {
					let s = i(e, pt),
						c = i(e, vt),
						d, y;
					return n.config.widthUnit === Nt ? d = DE.test(s) ? parseFloat(s) : parseFloat(r.width) : d = (0, Ct.default)(parseFloat(s), parseFloat(r.width)), n.config.heightUnit === Nt ? y = DE.test(c) ? parseFloat(c) : parseFloat(r.height) : y = (0, Ct.default)(parseFloat(c), parseFloat(r.height)), {
						widthValue: d,
						heightValue: y
					}
				}
		...
		function YM(e, t, r, n, o) {
			...
			kt(e, Xe.TRANSFORM_PREFIXED, o), a(e, Xe.TRANSFORM_PREFIXED, i), ZM(n, r) && a(e, Xe.TRANSFORM_STYLE_PREFIXED, yM)
		}
		...
		function i1(e, t, r, n, o, i) {
			...
			switch (n.actionTypeId) {
				case _r: {
					...
					d !== void 0 && (s === Nt && (s = "px"), kt(e, pt, i), a(e, pt, d + s)), y !== void 0 && (c === Nt && (c = "px"), kt(e, vt, i), a(e, vt, y + c));
					break
				}
				case en: {
					QM(e, r, n.config, i);
				...
				case Ir: {
					let s = Ka[n.actionTypeId],
						...
						h = r.aValue;
					kt(e, s, i), a(e, s, h >= 1 ? `rgb(${c},${d},${y})` : `rgba(${c},${d},${y},${h})`);
					break
				}
				default: {
					let {
		...
		function FE({
			...
			n.forEach(({
				...
				let a;
				(0, ht.isPluginType)(o) ? a = (0, ht.clearPlugin)(o): a = KE({
					effect: u1,
					actionTypeId: o,
					elementApi: r
				}), za({
		...
		function u1(e, t, r) {
			...
			jE(e, t, r), n(e, t, ""), t === Xe.TRANSFORM_PREFIXED && n(e, Xe.TRANSFORM_STYLE_PREFIXED, "")
		}
		...
		function l1({
			...
			let {
				actionItemGroups: n,
				continuousParameterGroups: o
			} = e, i = [], a = s => (i.push((0, xE.mergeIn)(s, ["config"], {
				delay: 0,
				duration: 0
			})), s.id === t);
			return n && n.some(({
	...
	var JE = u(Ei => {
		...
		var QE = Be(),
			...
			q1 = (e, t) => {
				...
				for (let Y = 0, {
					...
					if (Y === 0 && (S = te[0]), x >= oe) {
						...
						let U = o[Y + 1],
							O = U && x !== oe;
						D = O ? U.actionItems[0] : null, O && (P = oe / 100, L = (U.keyframe - oe) / 100)
					}
				}
				let W = {};
				if (S && !D)
			...
			P1 = (e, t) => {
				...
				h != null && (M = h), N = m ?? N, a === C1 ? M = 0 : (i || A) && (M = N = 0);
				let {
					now: x
				} = t.payload;
				if (r && n) {
					...
					return y.length && (W = y.reduce((Y, Q) => {
						...
						return Y[Q] = O, Y
					}, {})), L.current = W, L.position = D, D === 1 && (L.active = !1, L.complete = !0), (0, Or.merge)(e, L)
				}
				return e
			},
				...
				switch (t.type) {
					...
					case b1: {
						let {
							...
							actionTypeId: Q
						} = o, oe = N1(Q), te = x1(oe, Q), U = Object.keys(m).filter(F => m[F] != null), {
							easing: O
						} = o.config;
						return (0, Or.set)(e, r, {
							id: r,
	...
	var rg = u((Ej, rn) => {
		...
		rn.exports = Y1, rn.exports.__esModule = !0, rn.exports.default = rn.exports
	});
	var ig = u((gj, ng) => {
		var Q1 = At(),
			$1 = xe(),
	...
	var xg = u((wj, Ng) => {
		...
		function QF(e, t, r, n) {
			...
			for (var o = -1, i = t.length, a = i - 1, s = e; s != null && ++o < i;) {
				...
				if (o != a) {
					var y = s[c];
					d = n ? n(y, c, s) : void 0, d === void 0 && (d = Cg(y) ? y : zF(t[o + 1]) ? [] : {})
				}
				jF(s, c, d), s = s[c]
			}
			return e
	...
	var Hg = u((Lj, kg) => {
		...
		function A2(e, t) {
			...
			return t = O2(t), b2(e, r, function(n, o) {
				return t(n, o[0])
			})
		}
		kg.exports = A2
	...
	var Yg = u((Mj, zg) => {
		...
		function B2(e) {
			if (e == null) return !0;
			if (D2(e) && (L2(e) || typeof e == "string" || typeof e.splice == "function" || M2(e) || G2(e) || P2(e))) return !e.length;
			var t = q2(e);
	...
	var $g = u((Fj, Qg) => {
		...
		function K2(e, t) {
			var r = {};
			return t = j2(t, 3), H2(e, function(n, o, i) {
				k2(r, o, t(n, o, i))
			}), r
		}
		Qg.exports = K2
	...
	var u_ = u((Vj, s_) => {
		...
		function uG(e, t, r) {
			...
			t = a_(t) || 0, iG(r) && (y = !!r.leading, h = "maxWait" in r, i = h ? aG(a_(r.maxWait) || 0, t) : i, m = "trailing" in r ? !!r.trailing : m);
	...
	var l_ = u((Bj, c_) => {
		...
		function dG(e, t, r) {
			...
			return lG(r) && (n = "leading" in r ? !!r.leading : n, o = "trailing" in r ? !!r.trailing : o), cG(e, t, {
				leading: n,
				maxWait: t,
				trailing: o
			})
		...
		function lX({
			...
			if (e) {
				...
				if (e.indexOf(p_) !== -1) {
					let n = e.split(p_),
						o = n[0];
					if (r = n[1], o !== document.documentElement.getAttribute(v_)) return null
				}
	...
	var bi = u((lK, ry) => {
		...
		function Oi(e) {
			this.__wrapped__ = e, this.__actions__ = [], this.__dir__ = 1, this.__filtered__ = !1, this.__iteratees__ = [], this.__takeCount__ = oU, this.__views__ = []
		}
	...
	var Iy = u((_K, my) => {
		...
		function MU(e, t, r) {
			return r === void 0 && (r = t, t = void 0), r !== void 0 && (r = ss(r), r = r === r ? r : 0), t !== void 0 && (t = ss(t), t = t === t ? t : 0), DU(ss(e), t, r)
		}
		my.exports = MU
	});
	var Xy = u(Ni => {
		...
		var ze = Ci(nr()),
			...
			Gy = e => (t, r) => {
				let {
					type: n
				} = t.nativeEvent, o = [cs, Ly].indexOf(n) !== -1 ? n === cs : r.isActive, i = (0, ze.default)({}, r, {
					isActive: o
				});
			...
			Ay = e => (t, r = {}) => {
				...
				let I = (y ? c : i * (c || 0) / 100) / h,
					A, w, M = 0;
				r && (A = m > r.percentTop, w = r.scrollingDown !== A, M = w ? m : r.anchorTop);
			...
			Ry = (0, ze.default)({}, fs, {
				handler: vW((e, t) => {
					...
					return !a[n.action.config.autoStopEventId] && t.triggered ? t : n.eventTypeId === xy === r ? (He(e), (0, ze.default)({}, t, {
						triggered: !0
					})) : t
				})
			}),
				...
				[tW]: {
					...
					handler: ({
						...
						let {
							...
							pageX: I = i.pageX,
							pageY: A = i.pageY
						} = n, w = s === "X_AXIS", M = n.type === "mouseout", N = y / 100, x = c, S = !1;
						switch (a) {
						...
						return M && (N > 1 - Cy || N < Cy) && (N = Math.round(N)), (a !== jt.EventBasedOn.ELEMENT || S || S !== i.elementHovered) && (N = d ? 1 - N : N, e.dispatch((0, Ai.parameterChanged)(x, N))), {
							elementHovered: S,
							clientX: h,
							clientY: m,
							pageX: I,
				...
				[iW]: {
					...
					handler: ({
						...
						if (y === jt.EventBasedOn.VIEWPORT) {
							let D = S ? i / s : a / c;
							return D !== o.scrollPercent && t.dispatch((0, Ai.parameterChanged)(m, D)), {
								scrollPercent: D
							}
						} else {
							let D = Oy(n, m),
							...
							return O !== o.scrollPercent && t.dispatch((0, Ai.parameterChanged)(D, O)), {
								scrollPercent: O
							}
						}
					}
	...
	var ds = u(qt => {
		...
		function Di({
			...
			})), r && (sV(e), rV(), e.getState().ixSession.hasDefinedMediaQueries && QW(e)), e.dispatch((0, Oe.sessionStarted)()), nV(e, n))
		}
		...
		function nV(e, t) {
			let r = n => {
				...
				o.active && (e.dispatch((0, Oe.animationFrameChanged)(n, i)), t ? $W(e, r) : requestAnimationFrame(r))
			};
		...
		function pV({
			...
			(0, sn.default)(s, (h, m) => {
				...
				kW(M, i.mediaQueryKeys) || t.dispatch((0, Oe.mediaQueriesDefined)()), A.actionTypeId === ot.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION && (Array.isArray(I.config) ? I.config : [I.config]).forEach(S => {
					let {
						continuousParameterGroupId: D
					} = S, P = (0, xt.default)(a, `${N}.continuousParameterGroups`, []), L = (0, TW.default)(P, ({
						id: Q
			...
			let c = h => {
				...
				y = ({
					...
					m.split(" ").filter(Boolean).forEach(A => {
						let w = I ? d : c;
						h.addEventListener(A, w), t.dispatch((0, Oe.eventListenerAdded)(h, [A, w]))
					})
				};
		...
		function zy({
			...
			(0, sn.default)(t, r => {
				if (!r.continuous) {
					...
					ms(r, e), o && e.dispatch((0, Oe.actionListPlaybackChanged)({
						actionListId: n,
						isPlaying: !1
					}))
				}
		...
		function _s({
			...
			let {
				...
				mediaQueries: I = d.mediaQueryKeys
			} = m, A = (0, xt.default)(d, `actionLists.${o}`, {}), {
				actionItemGroups: w,
				useFirstGroupAsInitialState: M
			} = A;
			if (!w || !w.length) return !1;
			i >= w.length && (0, xt.default)(m, "config.loop") && (i = 0), i === 0 && M && i++;
		...
		function ys(e) {
			...
			let {
				...
				refState: x
			} = A[N] || {}, S = Re.getRefType(i), D = w.reducedMotion && ot.ReducedMotionTypes[a.actionTypeId], P;
			...
			if (r.dispatch((0, Oe.instanceAdded)((0, mW.default)({
					...
					skipMotion: D,
					skipToValue: P
				}, o))), Yy(document.body, "ix2-animation-started", I), s) {
				hV(r, I);
				return
			}
			Kt({
	...
	var im = u((OK, nm) => {
		...
		br.define("links", nm.exports = function(e, t) {
			...
			function I() {
				o = i && br.env("design"), m = br.env("slug") || a.pathname || "", br.scroll.off(w), h = [];
		...
		Gi.define("scroll", om.exports = function(e) {
			...
			function D(U) {
				...
				if (!(Gi.env("design") || window.$.mobile && /(?:^|\s)ui-link(?:$|\s)/.test(O.className))) {
					...
					if (F !== "") {
						var X = e(F);
						X.length && (U && (U.preventDefault(), U.stopPropagation()), P(F, U), window.setTimeout(function() {
							L(X, function() {
	...
	var fm = u((wK, lm) => {
		...
		Xi.define("forms", lm.exports = function(e, t) {
			...
			function D() {
				I = !0, n.on("submit", s + " form", function($) {
					var Z = e.data(this, s);
			...
			function F(G) {
				...
				G.done.toggle(E), G.fail.toggle(!E), E ? G.done.focus() : G.fail.focus(), K.toggle(!E), P(G)
			}
			...
			function B(G, K) {
				...
				if (m || de.on("click keydown", function(T) {
						T.type === "keydown" && T.which !== 13 && T.which !== 32 || (T.preventDefault(), Z.click())
					}), de.find(".w-icon-file-upload-icon").attr("aria-hidden", "true"), V.find(".w-icon-file-upload-remove").attr("aria-hidden", "true"), m) Z.on("click", function(T) {
					T.preventDefault()
					...
					V.on("click keydown", function(T) {
						...
						f = T.target && T.target.files && T.target.files[0], f && (_.toggle(!1), $.toggle(!1), v.toggle(!0), v.focus(), z.text(f.name), R() || L(K), K.fileUploads[G].uploading = !0, J(f, g))
					});
				...
				function l(T) {
					var C = T.responseJSON && T.responseJSON.msg,
						ee = We;
					typeof C == "string" && C.indexOf("InvalidFileTypeError") === 0 ? ee = ve : typeof C == "string" && C.indexOf("MaxFileSizeError") === 0 && (ee = k), ce.text(ee), Z.removeAttr("data-value"), Z.val(""), v.toggle(!1), _.toggle(!0), $.toggle(!0), $.focus(), K.fileUploads[G].uploading = !1, R() || P(K)
				}
				...
				function b(T) {
					if (T) return l(T);
					v.toggle(!1), j.css("display", "inline-block"), j.focus(), K.fileUploads[G].uploading = !1, R() || P(K)
				}
	...
	var pm = u((RK, dm) => {
		...
		Pt.define("navbar", dm.exports = function(e, t) {
			...
			function P() {
				d = h && Pt.env("design"), y = Pt.env("editor"), s = e(document.body), c = i.find(I), c.length && (c.each(Q), L(), W())
			}
			...
			function X(p) {
				return function(V) {
					switch (V.keyCode) {
						...
						case De.HOME:
						case De.END:
							return p.open ? (V.keyCode === De.END ? p.selectedIdx = p.links.length - 1 : p.selectedIdx = 0, J(p), V.preventDefault(), V.stopPropagation()) : (V.preventDefault(), V.stopPropagation())
					}
				}
			}
			...
			function B(p) {
				return function(V) {
					if (p.open) switch (p.selectedIdx = p.links.index(document.activeElement), V.keyCode) {
						case De.HOME:
						case De.END:
							return V.keyCode === De.END ? p.selectedIdx = p.links.length - 1 : p.selectedIdx = 0, J(p), V.preventDefault(), V.stopPropagation();
						case De.ESCAPE:
			...
			function de(p, V) {
				if (p.open) return;
				p.open = !0, p.menu.each($), p.links.addClass(x), p.dropdowns.addClass(w), p.dropdownToggle.addClass(M), p.dropdownList.addClass(N), p.button.addClass(A);
				var z = p.config,
					k = z.animation;
				...
				var ve = be(p),
					...
					l = p.el.height(),
					g = p.el[0];
				if (_(0, g), S.intro(0, g), Pt.redraw.up(), d || i.on("click" + I, p.outside), V) {
					T();
					return
				}
				...
				if (p.overlay && (D = p.menu.prev(), p.overlay.show().append(p.menu)), z.animOver) {
					n(p.menu).add(b).set({
						...
						x: 0
					}).then(T), p.overlay && p.overlay.width(Ye);
					return
				}
				var R = l + We;
				n(p.menu).add(b).set({
			...
			function ce(p, V) {
				...
				var z = p.config;
				if ((z.animation === "none" || !n.support.transform || z.duration <= 0) && (V = !0), S.outro(0, p.el[0]), i.off("click" + I, p.outside), V) {
					n(p.menu).stop(), g();
					return
				}
		...
		Lt.define("slider", hm.exports = function(e, t) {
			...
			function S(f, E) {
				...
				v || (v = e.data(E, c, {
					...
					el: _,
					config: {}
				})), v.mask = _.children(".w-slider-mask"), v.left = _.children(".w-slider-arrow-left"), v.right = _.children(".w-slider-arrow-right"), v.nav = _.children(".w-slider-nav"), v.slides = v.mask.children(".w-slide"), v.slides.each(m.reset), A && (v.maskWidth = 0), _.attr("role") === void 0 && _.attr("role", "region"), _.attr("aria-label") === void 0 && _.attr("aria-label", "carousel");
			...
			function D(f) {
				...
				if (E.duration = _ != null ? parseInt(_, 10) : 500, P(f.el.attr("data-infinite")) && (E.infinite = !0), P(f.el.attr("data-disable-swipe")) && (E.disableSwipe = !0), P(f.el.attr("data-hide-arrows")) ? E.hideArrows = !0 : f.config.hideArrows && (f.left.show(), f.right.show()), P(f.el.attr("data-autoplay"))) {
			...
			function oe(f, E) {
				var _ = null;
				E === f.slides.length && (w(), J(f)), t.each(f.anchors, function(v, j) {
			...
			function O(f) {
				return function(E, _) {
					...
					if (E.type === "swipe") return v.disableSwipe || Lt.env("editor") ? void 0 : _.direction === "left" ? Q(f)() : _.direction === "right" ? Y(f)() : void 0;
			...
			function X(f, E) {
				...
				if (p.find(vm).removeAttr("tabindex"), p.removeAttr("aria-hidden"), p.find("*").removeAttr("aria-hidden"
{
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"id": "a8d0c125-0a24-5c27-9357-3789aad28c41",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-491": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"id": "a8d0c125-0a24-5c27-9357-3789aad28c48",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-495": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"id": "a8d0c125-0a24-5c27-9357-3789aad28c4f",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-497": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"id": "a8d0c125-0a24-5c27-9357-3789aad28c56",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-499": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"id": "a8d0c125-0a24-5c27-9357-3789aad28c5d",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-531": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"id": "64134e195fa4f714e5f5bd98|18261a77-68eb-cce0-5e12-4dee7705167c",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-533": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"id": "64134e195fa4f714e5f5bd98|fae4f818-b944-b428-2b57-cf16b420b080",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-535": {
			...
			"target": {
				"selector": ".slide-2",
				"originalId": "640a583d5ae83b5c2a087f01|c2d0e610-6819-fab8-b107-663fa25ba4f3",
				"appliesTo": "CLASS"
			},
			"targets": [{
				"selector": ".slide-2",
		...
		"e-553": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"id": "ecb640f4-e0b6-8cc0-f441-1ff0b5b9ef08",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
	...
	"actionLists": {
				...
				"actionItems": [{
					...
					"config": {
						...
						"target": {
							...
							"selector": ".faq-answer",
							"selectorGuids": ["d1514668-2069-9ebf-8ee2-671f0419be04"]
						},
						"heightValue": 0,
						"widthUnit": "PX",
						"heightUnit": "px",
					...
					"config": {
						...
						"target": {
							...
							"selector": ".arrow",
							"selectorGuids": ["00d9d6f1-f4b2-8748-2aaf-5bbb7441a11f"]
						},
						"zValue": 0,
						"xUnit": "DEG",
						"yUnit": "DEG",
				...
				"actionItems": [{
					...
					"config": {
						...
						"target": {
							"useEventTarget": "CHILDREN",
							"selector": ".image-30",
							"selectorGuids": ["9143537f-acd7-0469-7e98-3c8a0ac82bf6"]
						},
						"value": "none"
					}
				}, {
					...
					"config": {
						...
						"duration": 0,
						"target": {
							"id": "640a583d5ae83b5c2a087f01|1e5e6b39-e99f-0c91-46e9-295f21e5af13"
						},
						"value": "block"
					}
				}, {
					...
					"config": {
						...
						"duration": 0,
						"target": {
							"id": "2210e3f6-e179-fb16-8a8a-00a6cfc43839"
						},
						"value": "block"
					}
				}]
			...
			"actionItemGroups": [{
				"actionItems": [{
					...
					"config": {
						...
						"target": {
							"useEventTarget": "CHILDREN",
							"selector": ".sub-heading-01.color-gray",
							"selectorGuids": ["e80e0799-72b0-bd1f-44d3-fbab86c3858f", "68e9c247-61ad-a67b-64bd-60e9c6923a7a"]
						},
						"globalSwatchId": "1b71db42",
						"rValue": 20,
						"bValue": 20,
						"gValue": 20,
						"aValue": 1
					...
					"config": {
						...
						"target": {
							"useEventTarget": true,
							"id": "640a583d5ae83b5c2a087f01|c6130dec-47ed-2e70-54a5-3a7ffdbcfc39"
						},
						"globalSwatchId": "1b71db42",
						"rValue": 20,
						"bValue": 20,
					...
					"config": {
						...
						"target": {
							"useEventTarget": "CHILDREN",
							"selector": ".body-01.color-gray",
							"selectorGuids": ["0f2f7b21-af91-c33a-dcb0-7da107cb00c8", "5bb42ee8-1298-f8d6-3d6e-6b3aa9a647fb"]
						},
						"globalSwatchId": "1b71db42",
						"rValue": 20,
						"bValue": 20,
			...
			"actionItemGroups": [{
				"actionItems": [{
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "640a583d5ae83b5c2a087f01|22bba114-2cc7-74eb-17bf-28e77873710b"
						},
						"xValue": -10,
						"xUnit": "deg",
						"yUnit": "DEG",
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "640a583d5ae83b5c2a087f01|39af70da-270b-e40f-2ca5-90f68f1c8018"
						},
						"xValue": -10,
						"xUnit": "deg",
						"yUnit": "DEG",
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "640a583d5ae83b5c2a087f01|d5e647ca-a00c-d709-80cf-c9fc506c9f34"
						},
						"xValue": -10,
						"yValue": 10,
						"xUnit": "deg",
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "640a583d5ae83b5c2a087f01|72a7726d-6753-0159-df5b-f5745f1fdde8"
						},
						"yValue": 120,
						"xUnit": "PX",
						"yUnit": "%",
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "640a583d5ae83b5c2a087f01|bdfb8b7a-2eb5-6a15-82a4-b4fe8b03940b"
						},
						"xValue": -10,
						"yValue": 10,
						"xUnit": "deg",
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "640a583d5ae83b5c2a087f01|e67357e5-c362-214a-775e-d0d31a5b3899"
						},
						"yValue": 120,
						"xUnit": "PX",
						"yUnit": "%",
					...
					"config": {
						...
						"duration": 0,
						"target": {
							"id": "640a583d5ae83b5c2a087f01|9eae53e8-54ce-03d4-aa0a-92258787df02"
						},
						"value": "block"
					}
				}, {
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "640a583d5ae83b5c2a087f01|390ce533-204e-d0c0-ed78-ee7f9acefaac"
						},
						"xValue": 1.7,
						"yValue": 1.7,
						"locked": true
			...
			"actionItemGroups": [{
				"actionItems": [{
					...
					"config": {
						...
						"duration": 30000,
						"target": {
							"id": "640a583d5ae83b5c2a087f01|d5de2b0b-71d0-7451-15dd-02b625e4ef0e"
						},
						"xValue": -100,
						"xUnit": "%",
						"yUnit": "PX",
					...
					"config": {
						...
						"duration": 30000,
						"target": {
							"id": "640a583d5ae83b5c2a087f01|7e4bfa68-d9d6-54b4-1295-73dc461a1708"
						},
						"xValue": -100,
						"xUnit": "%",
						"yUnit": "PX",
			...
			"actionItemGroups": [{
				"actionItems": [{
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "641309dfe41c113db81e19a3|f56fce8a-0016-4408-c8d6-2776c2ea4a4b"
						},
						"xValue": -10,
						"xUnit": "deg",
						"yUnit": "DEG",
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "641309dfe41c113db81e19a3|e88963ff-fde9-8ea2-e9f7-8dcaf7e1c48f"
						},
						"xValue": -10,
						"xUnit": "deg",
						"yUnit": "DEG",
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "641309dfe41c113db81e19a3|c6473f0a-d859-d876-af6a-a725281403c8"
						},
						"xValue": -10,
						"xUnit": "deg",
						"yUnit": "DEG",
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "641309dfe41c113db81e19a3|c5a48227-50d7-7ddd-2a25-fcd16b0d5021"
						},
						"xValue": -10,
						"xUnit": "deg",
						"yUnit": "DEG",
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "641309dfe41c113db81e19a3|815eefa3-ed34-08c3-e5ab-13b7c6fe0a9e"
						},
						"yValue": 80,
						"xUnit": "PX",
						"yUnit": "%",
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "641309dfe41c113db81e19a3|b785d35f-7e07-2c3a-7eaa-6d4b6ed1fa6e"
						},
						"yValue": 80,
						"xUnit": "PX",
						"yUnit": "%",
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "641309dfe41c113db81e19a3|59ba115d-c632-bc95-1f2c-2a13e85ff3fc"
						},
						"yValue": 80,
						"xUnit": "PX",
						"yUnit": "%",
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "641309dfe41c113db81e19a3|4d322889-c0ad-6471-0f6e-c9c639d31847"
						},
						"yValue": 80,
						"xUnit": "PX",
						"yUnit": "%",
			...
			"actionItemGroups": [{
				"actionItems": [{
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "64131c852b7f0cc922a77f9f|05479ebc-c373-c822-befa-af51e78a83aa"
						},
						"yValue": 130,
						"xUnit": "PX",
						"yUnit": "%",
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "64131c852b7f0cc922a77f9f|48c1987a-b194-c2fd-4572-faafc0790b6c"
						},
						"yValue": 130,
						"xUnit": "PX",
						"yUnit": "%",
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "64131c852b7f0cc922a77f9f|43f5ac8a-83b9-dc32-aba7-b0c56599474b"
						},
						"yValue": 130,
						"xUnit": "PX",
						"yUnit": "%",
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "64131c852b7f0cc922a77f9f|55429cd4-4095-70e9-b625-00e99193a186"
						},
						"yValue": 80,
						"xUnit": "PX",
						"yUnit": "%",
			...
			"actionItemGroups": [{
				"actionItems": [{
					...
					"config": {
						...
						"duration": 30000,
						"target": {
							"id": "64131c852b7f0cc922a77f9f|0a4f2477-59bd-705a-68b0-d2bb3290af5e"
						},
						"xValue": -100,
						"xUnit": "%",
						"yUnit": "PX",
					...
					"config": {
						...
						"duration": 30000,
						"target": {
							"id": "64131c852b7f0cc922a77f9f|924b577e-e645-f47f-6d16-5afb55247f3f"
						},
						"xValue": -100,
						"xUnit": "%",
						"yUnit": "PX",
			...
			"actionItemGroups": [{
				"actionItems": [{
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "641338380b55414bd2446b2e|5304b5ec-bca7-465d-447a-5f0e8d3f4b7b"
						},
						"xValue": -10,
						"xUnit": "deg",
						"yUnit": "DEG",
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "641338380b55414bd2446b2e|a1a50798-fc57-619f-fd7d-f028a7f0e5e9"
						},
						"xValue": -10,
						"xUnit": "deg",
						"yUnit": "DEG",
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "641338380b55414bd2446b2e|f98c0b94-6122-9d98-5e9c-4bbad738708d"
						},
						"yValue": 80,
						"xUnit": "PX",
						"yUnit": "%",
					...
					"config": {
						...
						"target": {
							"boundaryMode": true,
							"id": "641338380b55414bd2446b2e|833b3a1d-b120-8cc2-9b21-3efb42a2125e"
						},
						"xValue": 1.2,
						"yValue": 1.2,
						"locked": true
					...
					"config": {
						...
						"target": {
							"boundaryMode": true,
							"id": "641338380b55414bd2446b2e|7ce4c47f-bfbc-aa36-d8bb-21675482a8bf"
						},
						"globalSwatchId": "799e7663",
						"rValue": 255,
						"bValue": 255,
						"gValue": 255,
						"aValue": 1
			...
			"actionItemGroups": [{
				"actionItems": [{
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "64134e195fa4f714e5f5bd98|31110590-9b44-d1e2-2a6d-263f6ad0ccfb"
						},
						"yValue": 180,
						"xUnit": "PX",
						"yUnit": "%",
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "64134e195fa4f714e5f5bd98|c5cce48f-39c2-c943-5d8d-fae54d3b1e49"
						},
						"yValue": 180,
						"xUnit": "PX",
						"yUnit": "%",
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "64134e195fa4f714e5f5bd98|fc30489e-bbd3-d480-85c2-1af6eb817261"
						},
						"value": 0,
						"unit": ""
					}
		...
		"a-18": {
			...
			"actionItemGroups": [{
				"actionItems": [{
					...
					"config": {
						...
						"target": {
							"selector": ".blog-cover",
							"selectorGuids": ["220463a5-d40c-b3fe-186f-c96657d7098f"]
						},
						"value": 1,
						"unit": ""
					}
					...
					"config": {
						...
						"target": {
							...
							"selectorGuids": ["708f0ce4-4ce4-33bd-b571-b6468fc55c2e"]
						},
						"xValue": 1.3,
						"yValue": 1.3,
						"locked": true
			...
			"useFirstGroupAsInitialState": true,
			"createdOn": 1679446889621
		},
		"a-25": {
			"id": "a-25",
			"title": "Project Single Load",
			"actionItemGroups": [{
				"actionItems": [{
					"id": "a-25-n",
					"actionTypeId": "TRANSFORM_MOVE",
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "64124cd8d8bb7f3683d9badd|ffe227f0-3776-ca67-51f0-28b1a34db301"
						},
						"yValue": 80,
						"xUnit": "PX",
						"yUnit": "%",
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "64124cd8d8bb7f3683d9badd|9c061c0d-1d9d-7c56-9ee9-e27da91489cf"
						},
						"yValue": 80,
						"xUnit": "PX",
						"yUnit": "%",
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "64124cd8d8bb7f3683d9badd|974188d0-89ed-1b95-7789-32f4e4d855cb"
						},
						"yValue": 80,
						"xUnit": "PX",
						"yUnit": "%",
		...
		"a-26": {
			...
			"actionItemGroups": [{
				"actionItems": [{
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "64137b2273dd9740e1bdb942|1c4bfcc6-7b24-3ae9-155e-9d94dbc147cd"
						},
						"yValue": 80,
						"xUnit": "PX",
						"yUnit": "%",
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "64137b2273dd9740e1bdb942|e4b85327-c4be-9330-7dbc-b5ef7449569e"
						},
						"yValue": 80,
						"xUnit": "PX",
						"yUnit": "%",
			...
			"useFirstGroupAsInitialState": true,
			"createdOn": 1679500818295
		},
		"a-27": {
			"id": "a-27",
			"title": "Changelog Load",
			"actionItemGroups": [{
				"actionItems": [{
					"id": "a-27-n-2",
					"actionTypeId": "STYLE_OPACITY",
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "64138237828efb3faa02761f|8d654ca2-499c-4f19-f72e-24bf920215a2"
						},
						"value": 0,
						"unit": ""
					}
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "64138237828efb3faa02761f|6795d852-0107-ae10-580f-cb692278e722"
						},
						"xValue": 0,
						"yValue": 0,
						"locked": true
			...
			"useFirstGroupAsInitialState": true,
			"createdOn": 1679501213834
		},
		"a-28": {
			"id": "a-28",
			"title": "Style Guide Load",
			"actionItemGroups": [{
				"actionItems": [{
					"id": "a-28-n-2",
					"actionTypeId": "STYLE_OPACITY",
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "64138a986ffbf73633044d83|8cb1d3fc-b343-8e89-0c32-848488068b0a"
						},
						"value": 0,
						"unit": ""
					}
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "64138a986ffbf73633044d83|8cb1d3fc-b343-8e89-0c32-848488068b0d"
						},
						"value": 0,
						"unit": ""
					}
			...
			"actionItemGroups": [{
				"actionItems": [{
					...
					"config": {
						...
						"target": {
							"useEventTarget": "CHILDREN",
							"selector": ".project-image-box-3",
							"selectorGuids": ["79f52bb7-333d-4b8b-20d2-2f0f48974f56"]
						},
						"yValue": 50,
						"xUnit": "PX",
						"yUnit": "%",
					...
					"config": {
						...
						"target": {
							"useEventTarget": "CHILDREN",
							"selector": ".card-whipe",
							"selectorGuids": ["79f52bb7-333d-4b8b-20d2-2f0f48974f58"]
						},
						"widthValue": 100,
						"heightValue": 0,
						"widthUnit": "%",
					...
					"config": {
						...
						"target": {
							...
							"selectorGuids": ["79f52bb7-333d-4b8b-20d2-2f0f48974f55"]
						},
						"xValue": 0,
						"xUnit": "px",
						"yUnit": "PX",
		...
		"a-3": {
				...
				"actionItems": [{
					...
					"config": {
						...
						"target": {
							"useEventTarget": "CHILDREN",
							"selector": ".image-23",
							"selectorGuids": ["d8da9089-679c-4a61-0356-e5a22d3f4954"]
						},
						"value": "none"
					}
				}]
				...
				"actionItems": [{
					...
					"config": {
						...
						"target": {
							"useEventTarget": "CHILDREN",
							"selector": ".image-24",
							"selectorGuids": ["b28e0b06-72c3-2c27-4ef8-c4c8e89fa4f7"]
						},
						"value": "none"
					}
				}, {
			...
			"useFirstGroupAsInitialState": true,
			"createdOn": 1678972351453
		},
		"a-4": {
			"id": "a-4",
			"title": "Awards Hover 2",
			"actionItemGroups": [{
				"actionItems": [{
					"id": "a-4-n",
					"actionTypeId": "GENERAL_DISPLAY",
				...
				"actionItems": [{
					...
					"config": {
						...
						"target": {
							"useEventTarget": "CHILDREN",
							"selector": ".image-4",
							"selectorGuids": ["3a7d8f7e-9e4a-fc44-38d9-37825111b48d"]
						},
						"yValue": 120,
						"xUnit": "PX",
						"yUnit": "%",
		...
		"a-36": {
			...
			"actionItemGroups": [{
				"actionItems": [{
					...
					"config": {
						...
						"target": {
							"useEventTarget": "CHILDREN",
							"selector": ".tools-studio",
							"selectorGuids": ["36dc96ba-ccb4-3093-ab58-3e9e2ff36422"]
						},
						"xValue": 10,
						"xUnit": "%",
						"yUnit": "PX",
					...
					"config": {
						...
						"target": {
							"useEventTarget": "CHILDREN",
							"selector": ".tools-date",
							"selectorGuids": ["b2ff2508-2681-a5d8-9923-7c203a12ac24"]
						},
						"xValue": -20,
						"xUnit": "%",
						"yUnit": "PX",
			...
			"useFirstGroupAsInitialState": false,
			"createdOn": 1686759248430
		},
		"a-37": {
			"id": "a-37",
			"title": "Experience Hover out",
			"actionItemGroups": [{
				"actionItems": [{
					"id": "a-37-n",
					"actionTypeId": "TRANSFORM_MOVE",
				...
				"actionItems": [{
					...
					"config": {
						...
						"target": {
							"useEventTarget": "CHILDREN",
							"selector": ".image-31",
							"selectorGuids": ["b40a582f-df83-2390-7fbc-aff1c2b254e1"]
						},
						"xValue": null,
						"yValue": null,
						"zValue": -12,
					...
					"config": {
						...
						"target": {
							"useEventTarget": "CHILDREN",
							"selector": ".ts-text",
							"selectorGuids": ["21494ae0-f20e-a084-1f90-edbc02049bd9"]
						},
						"xValue": -100,
						"xUnit": "%",
						"yUnit": "PX",
		...
		"a-41": {
			...
			"actionItemGroups": [{
				"actionItems": [{
					...
					"config": {
						...
						"duration": 0,
						"target": {
							"id": "640a583d5ae83b5c2a087f01|a70b5a39-e79d-6e7d-fdcb-093b4b90276d"
						},
						"value": "none"
					}
				}, {
					...
					"config": {
						...
						"duration": 0,
						"target": {
							"id": "d0ee58de-ef61-d4cc-640d-e5776a949d58"
						},
						"value": "flex"
					}
				}, {
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "d0ee58de-ef61-d4cc-640d-e5776a949d5b"
						},
						"yValue": -10,
						"xUnit": "DEG",
						"yUnit": "deg",
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "d0ee58de-ef61-d4cc-640d-e5776a949d5a"
						},
						"yValue": 100,
						"xUnit": "PX",
						"yUnit": "%",
			...
			"useFirstGroupAsInitialState": true,
			"createdOn": 1687197217215
		},
		"a-24": {
			"id": "a-24",
			"title": "Blog Single Load",
			"actionItemGroups": [{
				"actionItems": [{
					"id": "a-24-n",
					"actionTypeId": "TRANSFORM_MOVE",
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "641272885486aa32b1fd332b|16dca80a-61e3-5c1b-701a-6f3890ba057a"
						},
						"yValue": 130,
						"xUnit": "PX",
						"yUnit": "%",
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "641272885486aa32b1fd332b|c27ccc94-dffb-76f8-1eec-530185f2538c"
						},
						"yValue": 130,
						"xUnit": "PX",
						"yUnit": "%",
					...
					"config": {
						...
						"target": {
							"boundaryMode": true,
							"id": "641272885486aa32b1fd332b|3af64c46-e7f7-de06-4045-c1b5063d2be9"
						},
						"yValue": 130,
						"xUnit": "PX",
						"yUnit": "%",
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "641272885486aa32b1fd332b|cd1d7ee3-135d-874a-be88-a0881c794565"
						},
						"yValue": 130,
						"xUnit": "PX",
						"yUnit": "%",
